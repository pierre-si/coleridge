        ...
        for sentence in sentences:
            ...
            if len(matches) == 0:
                ...
                for new_label in new_dataset_labels:
                    entry['text'] = sentence[:doc[matches[0][1]].idx] + new_label + sentence[doc[matches[0][2]].idx:]
...
for p in tqdm(publications):
    ...
    p_df.to_json('../input/smaller/augment/'+p.stem+'.jsonl', orient='records', lines=True)
# %%